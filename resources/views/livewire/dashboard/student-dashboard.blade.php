<div class="space-y-6">
    <x-ui.page-header
        title="Dashboard"
        subtitle="Ringkasan progress belajar, sesi, dan sertifikat kamu."
    >
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div class="rounded-2xl bg-slate-900 text-white p-5">
            <p class="text-sm text-slate-300">Learning Mode</p>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <section class="xl:col-span-2 space-y-4">
            <div class="flex items-end justify-between">
                <div>
                    ...
                    <p class="text-sm text-slate-500">Progress per course.</p>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                @empty
                    <x-ui.empty-state
                        ...
                        description="Kamu belum terdaftar di course mana pun."
        ...
        <aside class="space-y-4">
            <div class="rounded-2xl bg-white border p-5">
                <div class="flex items-end justify-between mb-3">
                    <div>
                        ...
                        <p class="text-sm text-slate-500">Zoom schedule.</p>
                    </div>
                </div>
            ...
            <div class="rounded-2xl bg-white border p-5">
                <div class="flex items-end justify-between mb-3">
                    <div>
                        <h2 class="font-semibold">Latest Certificates</h2>
                        <p class="text-sm text-slate-500">Recent completions.</p>
                    </div>
                </div>
