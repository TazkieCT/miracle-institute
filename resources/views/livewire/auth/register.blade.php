<div class="space-y-5 rounded-[2rem] border border-[#004777]/10 bg-white/95 p-6 shadow-[0_20px_60px_-24px_rgba(0,71,119,0.25)] backdrop-blur">
    ...
    <form wire:submit.prevent="submit" class="space-y-4">
        <div>
            <input type="text" required minlength="2" wire:model.debounce.300ms="name"
                placeholder="Name" class="w-full rounded-xl border border-[#004777]/15 bg-[#f4faff] px-4 py-2.5 text-[#004777] outline-none transition placeholder:text-[#004777]/35 focus:border-[#35A7FF] focus:bg-white">
        ...
        <div>
            <input type="password" required minlength="8" autocomplete="new-password"
                   ...
                   placeholder="Confirm password" class="w-full rounded-xl border border-[#004777]/15 bg-[#f4faff] px-4 py-2.5 text-[#004777] outline-none transition placeholder:text-[#004777]/35 focus:border-[#35A7FF] focus:bg-white">
    ...
    <div class="text-sm text-center">
        <a href="{{ route('login') }}" class="text-[#35A7FF] underline decoration-[#35A7FF]/50 underline-offset-4">Already have an account?</a>
    </div>
</div>