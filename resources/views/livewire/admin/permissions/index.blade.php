<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-[1.2fr_0.8fr] gap-6">
        ...
        <aside class="rounded-2xl bg-white border p-5 space-y-4 h-fit">
            <h2 class="font-semibold text-lg">{{ $editingId ? 'Edit' : 'New' }} Permission</h2>
            <input wire:model="name" class="w-full border rounded-xl px-4 py-2" placeholder="permission name">
